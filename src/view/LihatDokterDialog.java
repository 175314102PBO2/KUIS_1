...
public class LihatDokterDialog extends javax.swing.JDialog {
    ...
    public LihatDokterDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        this.dokterTableModel = DokterTableModel(FrameUtama.rumahSakit.getDaftarDokter());
        this.dokterTableModel = DokterTableModel(FrameUtama.rumahSakit.getDaftarDokter());
        initComponents();
    ...
    private DokterTableModel dokterTableModel = DokterTableModel(FrameUtama.rumahSakit.getDaftarDokter());
    ...
    public void updateTable() {
     ...
     DokterTableModel DokterTableModel(ArrayList<Dokter> daftarDokter) {
